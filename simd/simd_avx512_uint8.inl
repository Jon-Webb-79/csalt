...
static inline void simd_add_scalar_uint8(uint8_t*      data,
    ...
    switch (data_size) {
        case 1u: {
            const __m512i s = _mm512_set1_epi8((char)(*(const uint8_t*)scalar));
            size_t vec_end = (len / 64u) * 64u;
            for (; i < vec_end; i += 64u) {
                __m512i v = _mm512_loadu_si512((const void*)(data + i));
                v = _mm512_add_epi8(v, s);
                _mm512_storeu_si512((void*)(data + i), v);
            }
        ...
        case 2u: {
            ...
            const __m512i s = _mm512_set1_epi16((short)(*(const uint16_t*)scalar));
            size_t vec_end = (len / 32u) * 32u;
            for (; i < vec_end; i += 32u) {
                __m512i v = _mm512_loadu_si512((const void*)(d + i));
                v = _mm512_add_epi16(v, s);
        ...
        case 4u: {
            ...
            const __m512i s = _mm512_set1_epi32((int)(*(const uint32_t*)scalar));
        ...
        case 8u: {
            ...
            const __m512i s = _mm512_set1_epi64((long long)(*(const uint64_t*)scalar));
            size_t vec_end = (len / 8u) * 8u;
            for (; i < vec_end; i += 8u) {
                __m512i v = _mm512_loadu_si512((const void*)(d + i));
                v = _mm512_add_epi64(v, s);
                _mm512_storeu_si512((void*)(d + i), v);
            }
