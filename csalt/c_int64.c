...
bool int64_tensors_equal(const int64_tensor_t* one,
    ...
    if (meta) {
        for (int64_t d = 0u; d < one->base->ndim; d++) {
...
error_code_t min_int64_tensor(const int64_tensor_t* t, int64_t* value) {
    ...
    *value = INT64_MAX;
    return simd_min_int64((const int64_t*)t->base->data, t->base->len, value);
}
// ================================================================================
// ================================================================================
// eof
