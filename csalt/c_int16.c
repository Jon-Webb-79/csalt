...
error_code_t int16_tensor_lsearch(const int16_tensor_t* t,
    ...
    int16_t found_val = 0u;
    get_int16_tensor_index(t, result, &found_val);
...
error_code_t int16_tensor_bsearch(const int16_tensor_t* t,
    ...
    while (low <= high) {
        ...
        get_int16_tensor_index(t, mid, &test);
...
bracket_expect_t int16_tensor_bbsearch(const int16_tensor_t* t,
    ...
    int16_t first = 0u, last = 0u;
    get_int16_tensor_index(t, 0u,       &first);
    get_int16_tensor_index(t, len - 1u, &last);
...
bool int16_tensors_equal(const int16_tensor_t* one,
    ...
    if (meta) {
        for (int16_t d = 0u; d < one->base->ndim; d++) {
...
error_code_t min_int16_tensor(const int16_tensor_t* t, int16_t* value) {
    ...
    *value = INT16_MAX;
    return simd_min_int16((const int16_t*)t->base->data, t->base->len, value);
}
// ================================================================================
// ================================================================================
// eof
