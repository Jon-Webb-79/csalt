...
const struct CMUnitTest test_ldouble_vector[] = {
    ...
    // cmocka_unit_test(test_push_back_static),
    // cmocka_unit_test(test_generic_macros),
    // cmocka_unit_test(test_ldouble_vector_index),
    // cmocka_unit_test(test_push_back_special_values),
    // cmocka_unit_test(test_static_array_bounds),
    // cmocka_unit_test(test_static_array_index_bounds),
    // cmocka_unit_test(test_static_array_initialization),
...
//     cmocka_unit_test_setup_teardown(test_insert_ldouble_dict_basic, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_insert_ldouble_dict_duplicate, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_insert_ldouble_dict_null, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_get_ldouble_dict_value_basic, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_get_ldouble_dict_value_missing, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_update_ldouble_dict_basic, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_update_ldouble_dict_missing, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_pop_ldouble_dict_basic, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_pop_ldouble_dict_missing, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_resize_behavior, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_get_keys_ldouble_dict, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_get_values_ldouble_dict, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_foreach_ldouble_dict_basic, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_foreach_ldouble_dict_empty, setup, teardown),
//     cmocka_unit_test_setup_teardown(test_foreach_ldouble_dict_null, setup, teardown),
//     cmocka_unit_test(test_vector_dictionary),
//     cmocka_unit_test(test_vector_dictionary_resize),
//     cmocka_unit_test(test_vector_dictionary_gbc),
//     cmocka_unit_test(test_pop_vector_dictionary),
