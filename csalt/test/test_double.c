...
static inline double_v make_vec(double *buf, size_t n) {
    double_v v; v.data = buf; v.len = n; return v;
}
...
void test_double_bin_bounds_exact_middle(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    errno = 0;
    bin_dat bd = binary_search_bounds_double_vector(&v, 3.f, 0.f, false);
    assert_int_equal(errno, 0);
    assert_bounds(bd, 2, 2);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_exact_first(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 1.f, 0.f, false);
    assert_bounds(bd, 0, 0);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_exact_last(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 4.f, 0.f, false);
    assert_bounds(bd, 3, 3);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_near_hit_within_tol(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 3.0004f, 0.001f, false);
    assert_bounds(bd, 2, 2);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_near_miss_outside_tol(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 3.002f, 0.001f, false);
    assert_bounds(bd, 2, 3);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_inrange_miss(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 2.5f, 0.f, false);
    assert_bounds(bd, 1, 2);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_below_range(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, -10.f, 0.f, false);
    assert_bounds(bd, SIZE_MAX, 0);
}
// -------------------------------------------------------------------------------- 

void test_double_bin_bounds_above_range(void **state) {
    (void)state;
    double a[] = {1.f, 2.f, 3.f, 4.f};
    double_v v = make_vec(a, 4);
    bin_dat bd = binary_search_bounds_double_vector(&v, 10.f, 0.f, false);
