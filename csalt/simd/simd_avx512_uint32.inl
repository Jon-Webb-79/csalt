...
static inline error_code_t simd_min_uint32(const uint32_t* data,
    ...
    if (len >= 16u) {
        __m512i vmin = _mm512_set1_epi32((int)0xFFFFFFFF);
    ...
    if (i + 8u <= len) {
        __m256i vmin = _mm256_set1_epi32((int)cur_min);
