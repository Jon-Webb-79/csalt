...
static inline void _sse2_transpose_2x2(__m128d r0, __m128d r1,
                                       __m128d* o0, __m128d* o1) {
    *o0 = _mm_unpacklo_pd(r0, r1);   /* [a0 b0] */
    *o1 = _mm_unpackhi_pd(r0, r1);   /* [a1 b1] */
}
...
static inline void simd_transpose_double(const double* src,
    ...
    for (i = 0u; i < row_body; i += 2u) {
        for (j = 0u; j < col_body; j += 2u) {
            ...
            __m128d o0, o1;
            _sse2_transpose_2x2(r0, r1, &o0, &o1);
...
static inline bool simd_equal_double(const double* a,
    ...
    for (; i < body_end; i += 8u) {
        ...
        __m128i a1 = _mm_loadu_si128((const __m128i*)(a + i + 2u));
        __m128i b1 = _mm_loadu_si128((const __m128i*)(b + i + 2u));
        __m128i a2 = _mm_loadu_si128((const __m128i*)(a + i + 4u));
        __m128i b2 = _mm_loadu_si128((const __m128i*)(b + i + 4u));
        __m128i a3 = _mm_loadu_si128((const __m128i*)(a + i + 6u));
        __m128i b3 = _mm_loadu_si128((const __m128i*)(b + i + 6u));
 
        /* XOR pairs — any nonzero bit means mismatch */
        __m128i x0 = _mm_xor_si128(a0, b0);
        __m128i x1 = _mm_xor_si128(a1, b1);
        __m128i x2 = _mm_xor_si128(a2, b2);
        __m128i x3 = _mm_xor_si128(a3, b3);
