// ================================================================================
// ================================================================================
// - File:    simd_sve_min_int16.inl
// - Purpose: ARM SVE fast path for finding the minimum int16_t in a contiguous
//            buffer.  Uses predicated loads and svmin_s16_x for the vertical
//            pass and svminv_s16 for the final horizontal reduction.
//
// Source Metadata
...
#ifndef SIMD_SVE_MIN_INT16_INL
#define SIMD_SVE_MIN_INT16_INL
...
static inline error_code_t simd_min_int16(const int16_t* data,
    ...
    int16_t  cur_min = *out;
    size_t   i       = 0u;
    uint64_t vl      = svcnth();         /* int16 elements per SVE register */
