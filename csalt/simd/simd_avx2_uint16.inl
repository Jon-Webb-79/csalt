...
// ================================================================================
// ================================================================================
#ifndef CSALT_SIMD_AVX2_UINT16_INL
#define CSALT_SIMD_AVX2_UINT16_INL
...
static size_t simd_lsearch_uint16(const uint16_t* data,
    ...
    const size_t elems_per_reg = 16u;  /* 256 bits / 16 bits per uint16_t */
 
#if defined(__AVX2__)
    if (len >= elems_per_reg) {
        __m256i target = _mm256_set1_epi16((int16_t)value);
        ...
        /* Handle any remaining full 8-element SSE2 chunks */
