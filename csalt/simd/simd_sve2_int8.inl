// ================================================================================
// ================================================================================
// - File:    simd_sve2_min_int8.inl
// - Purpose: ARM SVE2 fast path for finding the minimum int8_t in a
//            contiguous buffer.  SVE2 does not add new signed-byte min
...
#ifndef SIMD_SVE2_MIN_INT8_INL
#define SIMD_SVE2_MIN_INT8_INL
