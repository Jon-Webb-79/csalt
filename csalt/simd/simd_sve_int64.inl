// ================================================================================
// ================================================================================
// - File:    simd_sve_min_int64.inl
// - Purpose: ARM SVE fast path for finding the minimum int64_t in a contiguous
//            buffer.  SVE provides native svmin_s64_x and svminv_s64 for
//            64-bit signed elements.  Uses predicated loads and a predicated
...
#ifndef SIMD_SVE_MIN_INT64_INL
#define SIMD_SVE_MIN_INT64_INL
...
static inline error_code_t simd_min_int64(const int64_t* data,
    ...
    int64_t  cur_min = *out;
    size_t   i       = 0u;
    uint64_t vl      = svcntd();         /* int64 elements per SVE register */
