 ...
 * consistent with the behaviour of uint16_array_contains. The array is not
 ...
 *
 *     size_expect_t r = uint16_array_min(arr);
 *     // r.has_value == true, r.u.value == 1  (value 100 is at index 1).
 *
 *     return_uint16_array(arr);
 * @endcode
 */
size_expect_t uint16_array_min(const uint16_array_t* array);
 ...
 *     // arr contains [300, 100, 200].
 *
 *     size_expect_t r = uint16_array_max(arr);
 *     // r.has_value == true, r.u.value == 0  (value 300 is at index 0).
 *
 *     return_uint16_array(arr);
 * @endcode
 */
size_expect_t uint16_array_max(const uint16_array_t* array);
// ================================================================================ 
// ================================================================================ 
#ifdef __cplusplus
}
